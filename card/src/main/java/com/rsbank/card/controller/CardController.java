...
public class CardController {
        ...
        @Operation(summary = "Create Card REST API", description = "REST API to create new Card inside RSBank")
        @ApiResponses({
        ...
        @GetMapping("/fetch")
        public ResponseEntity<CardDto> fetchCardDetails(@RequestHeader("rsbank-correlation-id") String correlationId,
                        @RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits") String mobileNumber) {
                
                logger.debug("rsbank-correlation-id found in CardController : {}", correlationId);
